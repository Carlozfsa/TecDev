  ...
  <div class="center-block" style="margin-left:25%">
    <nav aria-label="Page navigation">
        <ul class="pagination center-block">
            <li>
                <a href="{{url('/mat_l_1')}}" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
            <li><a href="{{url('/mat_l_1')}}">Lectura 1</a></li>
            <li><a href="{{url('/mat_l_2')}}" style="background-color: lightgray;">Lectura 2</a></li>
            <li><a href="{{url('/mat_1')}}"><strong>Primer ejercicio</strong></a></li>
            <li>
                <a href="{{url('/mat_1')}}" aria-label="Next">
