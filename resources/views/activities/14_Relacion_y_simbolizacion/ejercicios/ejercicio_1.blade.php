        ...
        <div class="panel-body">
            ...
            {!! Form::close() !!}
                ...
                @else
                    ...
                    {!! Form::open(['method'=>'POST', 'action'=>'RelacionsController@edit_rel_sim_1']) !!}
                        ...
                        <tr>
                            <td>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>{!! Form::text('a_e', $f_decode1, ['class'=>'form-control'])!!}</td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>{!! Form::text('e_e', $f_decode5, ['class'=>'form-control'])!!}</td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>{!! Form::text('b_e', $f_decode2, ['class'=>'form-control'])!!}</td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>{!! Form::text('f_e', $f_decode6, ['class'=>'form-control'])!!}</td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>{!! Form::text('c_e', $f_decode3, ['class'=>'form-control'])!!}</td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>{!! Form::text('g_e', $f_decode7, ['class'=>'form-control'])!!}</td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>{!! Form::text('d_e', $f_decode4, ['class'=>'form-control'])!!}</td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr>
                                        <td>{!! Form::text('h_e', $f_decode8, ['class'=>'form-control'])!!}</td>
                                    </tr>
                                </table>
                            </td>
    ...
    <div class="center-block" style="margin-left:13%">
        <nav aria-label="Page navigation">
            <ul class="pagination center-block">
                <li>
                    <a href="{{url('/inf_2')}}" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <li><a href="{{url('/inf_2')}}"><strong>Actividad previa</strong></a></li>
                <li><a href="{{url('/rel_sim_1')}}" style="background-color: lightgray;">Ejercicio 1</a></li>
                ...
                <li>
                    <a href="{{url('/rel_sim_2')}}" aria-label="Next">
