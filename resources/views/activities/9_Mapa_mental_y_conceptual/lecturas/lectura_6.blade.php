  ...
  <div class="center-block" style="margin-left:10%">
    <nav aria-label="Page navigation">
        <ul class="pagination center-block">
            <li>
                <a href="{{url('/mapas_l_5')}}" aria-label="Previous">
            ...
            <li><a href="{{url('/mapas_l_6')}}" style="background-color: lightgray;">Lectura 6</a></li>
            <li><a href="{{url('/mapas_1')}}"><strong>Primer ejercicio</strong></a></li>
            <li>
