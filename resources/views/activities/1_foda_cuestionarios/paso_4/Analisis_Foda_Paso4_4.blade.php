    ...
    <div class="panel panel-default table-responsive">
        ...
        <div class="panel-body">
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/store/foda_4_4')}}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dynamic_field">
                                <tr>
                                    <td ><input type="text" name="o4[]" placeholder="Escriba una oportunidad" class="form-control name_list center-block"></td>
                ...
                <div class="instrucciones" style="margin: 10px">
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/edit/foda_4_4')}}">
                        {{csrf_field()}}
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dynamic_field_edit">
                                @foreach($f_decode as $key=>$value)
                                    <tr id="row{{$key}}">
                                        <td ><input type="text" name="oe4[]" placeholder="Escriba una oportunidad" class="form-control name_list center-block" value="{{$value}}"></td>
    ...
    <div class="center-block" style="margin-left:8%">
        <nav aria-label="Page navigation">
            <ul class="pagination center-block">
                <li>
                    <a href="{{url('/foda_4_3')}}" aria-label="Previous">
                ...
                <li><a href="{{url('/foda_4_4')}}" style="background-color: lightgray;">Oportunidades 4</a></li>
                <li><a href="{{url('/foda_r')}}"><strong>Siguiente parte!</strong></a></li>
                <li>
                    <a href="{{url('/foda_r')}}" aria-label="Next">
...
<script>
    $(document).ready(function(){
        ...
        $('#add').click(function(){
            i++;
            $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="o4[]" placeholder="Escriba una oportunidad" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove center-block">X</button></td></tr>');
        });
...
<script>
    $(document).ready(function(){
        ...
        $('#add_edit').click(function(){
            i++;
            $('#dynamic_field_edit').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="oe4[]" placeholder="Escriba una oportunidad" class="form-control name_list" /></td><td><button type="button" name="remove_edit" id="'+i+'" class="btn btn-danger btn_remove_edit center-block">X</button></td></tr>');
        });
