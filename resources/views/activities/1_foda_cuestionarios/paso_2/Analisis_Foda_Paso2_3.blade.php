                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/store/foda_2_3')}}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dynamic_field">
                                <tr>
                                    <td ><input type="text" name="d3[]" placeholder="Escriba una debilidad" class="form-control name_list center-block"></td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dynamic_field_edit">
                                @foreach($f_decode as $key=>$value)
                                    <tr id="row{{$key}}">
                                        <td ><input type="text" name="de3[]" placeholder="Escriba una debilidad" class="form-control name_list center-block" value="{{$value}}"></td>
    ...
    <div class="center-block" style="margin-left:20%">
        <nav aria-label="Page navigation">
            <ul class="pagination center-block">
                <li>
                    <a href="{{url('/foda_2_2')}}" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <li><a href="{{url('/foda_2_1')}}">Debilidades 1</a></li>
                <li><a href="{{url('/foda_2_2')}}">Debilidades 2</a></li>
                <li><a href="{{url('/foda_2_3')}}" style="background-color: lightgray;">Debilidades 3</a></li>
                <li><a href="{{url('/foda_2_4')}}">Debilidades 4</a></li>
                <li>
                    <a href="{{url('/foda_2_4')}}" aria-label="Next">
...
<script>
    $(document).ready(function(){
        ...
        $('#add_edit').click(function(){
            i++;
            $('#dynamic_field_edit').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="de3[]" placeholder="Escriba una debilidad" class="form-control name_list" /></td><td><button type="button" name="remove_edit" id="'+i+'" class="btn btn-danger btn_remove_edit center-block">X</button></td></tr>');
        });
