  ...
  <div class="center-block" style="margin-left:30%">
    <nav aria-label="Page navigation">
        <ul class="pagination center-block">
            <li>
                <a href="{{url('/hab_est_l_1')}}" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
            <li><a href="{{url('/hab_est_l_1')}}">Lectura 1</a></li>
            <li><a href="{{url('/hab_est_l_2')}}" style="background-color: lightgray;">Lectura 2</a></li>
            <li><a href="{{url('/hab_est_l_3')}}">Lectura 3</a></li>
            <li>
                <a href="{{url('/hab_est_l_3')}}" aria-label="Next">
