  ...
  <div class="center-block" style="margin-left:0%">
    <nav aria-label="Page navigation">
        <ul class="pagination center-block">
            <<li>
                <a href="{{url('/des_hum_int_l_3')}}" aria-label="Previous">
            ...
            <li><a href="{{url('/des_hum_int_l_4')}}"style="background-color: lightgray;">Lectura 4</a></li>
            ...
            <li>
                <a href="{{url('/des_hum_int_l_5')}}" aria-label="Next">
