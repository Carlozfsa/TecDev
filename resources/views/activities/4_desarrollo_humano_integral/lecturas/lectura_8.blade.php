  ...
  <div class="center-block" style="margin-left:0%">
    <nav aria-label="Page navigation">
        <ul class="pagination center-block">
            <li>
                <a href="{{url('/des_hum_int_l_7')}}" aria-label="Previous">
            ...
            <li><a href="{{url('/des_hum_int_l_8')}}" style="background-color: lightgray;">Lectura 8</a></li>
            ...
            <li>
                <a href="{{url('/des_hum_int_l_9')}}" aria-label="Next">
