        ...
        <div class="panel-body">
            ...
            <div class="instrucciones" style="margin: 10px">
                ...
                @else
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/edit/tiempo_ej_2_7')}}">
                        {{csrf_field()}}
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_1">
                                            @foreach($f_decode1 as $key=>$value)
                                                <tr id="row_e_1{{$key}}">
                                                    <td><input type="text" name="sueno6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_2">
                                            @foreach($f_decode2 as $key=>$value)
                                                <tr id="row_e_2{{$key}}">
                                                    <td><input type="text" name="comida6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_3">
                                            @foreach($f_decode3 as $key=>$value)
                                                <tr id="row_e_3{{$key}}">
                                                    <td><input type="text" name="clase6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_4">
                                            @foreach($f_decode4 as $key=>$value)
                                                <tr id="row_e_4{{$key}}">
                                                    <td><input type="text" name="estudio6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_5">
                                            @foreach($f_decode5 as $key=>$value)
                                                <tr id="row_e_5{{$key}}">
                                                    <td><input type="text" name="rel6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_6">
                                            @foreach($f_decode6 as $key=>$value)
                                                <tr id="row_e_6{{$key}}">
                                                    <td><input type="text" name="soc6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_7">
                                            @foreach($f_decode7 as $key=>$value)
                                                <tr id="row_e_7{{$key}}">
                                                    <td><input type="text" name="dep6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_8">
                                            @foreach($f_decode8 as $key=>$value)
                                                <tr id="row_e_8{{$key}}">
                                                    <td><input type="text" name="per6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_1').click(function(){
                i++;
                $('#dynamic_field_edit_1').append('<tr id="row_e_1'+i+'" class="dynamic-added"><td><input type="text" name="sueno6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_1" id="'+i+'" class="btn btn-danger btn_remove_edit_1 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_2').click(function(){
                i++;
                $('#dynamic_field_edit_2').append('<tr id="row_e_2'+i+'" class="dynamic-added"><td><input type="text" name="comida6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_2" id="'+i+'" class="btn btn-danger btn_remove_edit_2 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_3').click(function(){
                i++;
                $('#dynamic_field_edit_3').append('<tr id="row_e_3'+i+'" class="dynamic-added"><td><input type="text" name="clase6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_3" id="'+i+'" class="btn btn-danger btn_remove_edit_3 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_4').click(function(){
                i++;
                $('#dynamic_field_edit_4').append('<tr id="row_e_4'+i+'" class="dynamic-added"><td><input type="text" name="estudio6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_4" id="'+i+'" class="btn btn-danger btn_remove_edit_4 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_5').click(function(){
                i++;
                $('#dynamic_field_edit_5').append('<tr id="row_e_5'+i+'" class="dynamic-added"><td><input type="text" name="rel6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_5" id="'+i+'" class="btn btn-danger btn_remove_edit_5 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_6').click(function(){
                i++;
                $('#dynamic_field_edit_6').append('<tr id="row_e_6'+i+'" class="dynamic-added"><td><input type="text" name="soc6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_6" id="'+i+'" class="btn btn-danger btn_remove_edit_6 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_7').click(function(){
                i++;
                $('#dynamic_field_edit_7').append('<tr id="row_e_7'+i+'" class="dynamic-added"><td><input type="text" name="dep6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_7" id="'+i+'" class="btn btn-danger btn_remove_edit_7 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_8').click(function(){
                i++;
                $('#dynamic_field_edit_8').append('<tr id="row_e_8'+i+'" class="dynamic-added"><td><input type="text" name="per6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_8" id="'+i+'" class="btn btn-danger btn_remove_edit_8 center-block">X</button></td></tr>');
            });
