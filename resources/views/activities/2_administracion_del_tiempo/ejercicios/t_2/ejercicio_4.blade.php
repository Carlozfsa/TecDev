                            ...
                            <td>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field1">
                                        <tr>
                                            <td ><input type="text" name="sueno3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block"></td>
                            ...
                            <td>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field2">
                                        <tr>
                                            <td ><input type="text" name="comida3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block"></td>
                            ...
                            <td>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field3">
                                        <tr>
                                            <td><input type="text" name="clase3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block"></td>
                            ...
                            <td>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field4">
                                        <tr>
                                            <td><input type="text" name="estudio3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block"></td>
                            ...
                            <td>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field5">
                                        <tr>
                                            <td><input type="text" name="rel3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block"></td>
                            ...
                            <td>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field6">
                                        <tr>
                                            <td><input type="text" name="soc3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block"></td>
                            ...
                            <td>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field7">
                                        <tr>
                                            <td><input type="text" name="dep3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block"></td>
                            ...
                            <td>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field8">
                                        <tr>
                                            <td><input type="text" name="per3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block"></td>
    ...
    <div class="center-block" style="margin-left:13%">
        <nav aria-label="Page navigation">
            <ul class="pagination center-block">
                <li>
                    <a href="{{url('/tiempo_ej_2_3')}}" aria-label="Previous">
                ...
                <li><a href="{{url('/tiempo_ej_2_4')}}" style="background-color: lightgray;">Parte 4</a></li>
                ...
                <li>
                    <a href="{{url('/tiempo_ej_2_5')}}" aria-label="Next">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add1').click(function(){
                i1++;
                $('#dynamic_field1').append('<tr id="row1'+i1+'" class="dynamic-added"><td><input type="text" name="sueno3[]" placeholder="Escriba su respuesta" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i1+'" class="btn btn-danger btn_remove1 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add2').click(function(){
                i2++;
                $('#dynamic_field2').append('<tr id="row2'+i2+'" class="dynamic-added"><td><input type="text" name="comida3[]" placeholder="Escriba su respuesta" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i2+'" class="btn btn-danger btn_remove2 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add3').click(function(){
                i3++;
                $('#dynamic_field3').append('<tr id="row3'+i3+'" class="dynamic-added"><td><input type="text" name="clase3[]" placeholder="Escriba su respuesta" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i3+'" class="btn btn-danger btn_remove3 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add4').click(function(){
                i4++;
                $('#dynamic_field4').append('<tr id="row4'+i4+'" class="dynamic-added"><td><input type="text" name="estudio3[]" placeholder="Escriba su respuesta" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i4+'" class="btn btn-danger btn_remove4 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add5').click(function(){
                i5++;
                $('#dynamic_field5').append('<tr id="row5'+i5+'" class="dynamic-added"><td><input type="text" name="rel3[]" placeholder="Escriba su respuesta" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i5+'" class="btn btn-danger btn_remove5 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add6').click(function(){
                i6++;
                $('#dynamic_field6').append('<tr id="row6'+i6+'" class="dynamic-added"><td><input type="text" name="soc3[]" placeholder="Escriba su respuesta" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i6+'" class="btn btn-danger btn_remove6 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add7').click(function(){
                i7++;
                $('#dynamic_field7').append('<tr id="row7'+i7+'" class="dynamic-added"><td><input type="text" name="dep3[]" placeholder="Escriba su respuesta" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i7+'" class="btn btn-danger btn_remove7 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add8').click(function(){
                i8++;
                $('#dynamic_field8').append('<tr id="row8'+i8+'" class="dynamic-added"><td><input type="text" name="per3[]" placeholder="Escriba su respuesta" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i8+'" class="btn btn-danger btn_remove8 center-block">X</button></td></tr>');
            });
