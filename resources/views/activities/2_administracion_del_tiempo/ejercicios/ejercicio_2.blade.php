                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_1">
                                            @foreach($f_decode1 as $key=>$value)
                                                <tr id="row_e_1{{$key}}">
                                                    <td ><input type="text" name="le1[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_2">
                                            @foreach($f_decode2 as $key=>$value)
                                                <tr id="row_e_2{{$key}}">
                                                    <td ><input type="text" name="le2[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_3">
                                            @foreach($f_decode3 as $key=>$value)
                                                <tr id="row_e_3{{$key}}">
                                                    <td ><input type="text" name="le3[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_4">
                                            @foreach($f_decode4 as $key=>$value)
                                                <tr id="row_e_4{{$key}}">
                                                    <td ><input type="text" name="le4[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_5">
                                            @foreach($f_decode5 as $key=>$value)
                                                <tr id="row_e_5{{$key}}">
                                                    <td ><input type="text" name="le5[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_6">
                                            @foreach($f_decode6 as $key=>$value)
                                                <tr id="row_e_6{{$key}}">
                                                    <td ><input type="text" name="le6[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_7">
                                            @foreach($f_decode7 as $key=>$value)
                                                <tr id="row_e_7{{$key}}">
                                                    <td ><input type="text" name="le7[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_8">
                                            @foreach($f_decode8 as $key=>$value)
                                                <tr id="row_e_8{{$key}}">
                                                    <td ><input type="text" name="le8[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_9">
                                            @foreach($f_decode9 as $key=>$value)
                                                <tr id="row_e_9{{$key}}">
                                                    <td ><input type="text" name="le9[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_10">
                                            @foreach($f_decode10 as $key=>$value)
                                                <tr id="row_e_10{{$key}}">
                                                    <td ><input type="text" name="le10[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_11">
                                            @foreach($f_decode11 as $key=>$value)
                                                <tr id="row_e_11{{$key}}">
                                                    <td ><input type="text" name="le11[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_12">
                                            @foreach($f_decode12 as $key=>$value)
                                                <tr id="row_e_12{{$key}}">
                                                    <td ><input type="text" name="le12[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dynamic_field_edit_13">
                                            @foreach($f_decode13 as $key=>$value)
                                                <tr id="row_e_13{{$key}}">
                                                    <td ><input type="text" name="le13[]" placeholder="Escriba su respuesta" class="form-control name_list center-block" value="{{$value}}"></td>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_1').click(function(){
                i++;
                $('#dynamic_field_edit_1').append('<tr id="row_e_1'+i+'" class="dynamic-added"><td><input type="text" name="le1[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_1" id="'+i+'" class="btn btn-danger btn_remove_edit_1 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_2').click(function(){
                i++;
                $('#dynamic_field_edit_2').append('<tr id="row_e_2'+i+'" class="dynamic-added"><td><input type="text" name="le2[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_2" id="'+i+'" class="btn btn-danger btn_remove_edit_2 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_3').click(function(){
                i++;
                $('#dynamic_field_edit_3').append('<tr id="row_e_3'+i+'" class="dynamic-added"><td><input type="text" name="le3[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_3" id="'+i+'" class="btn btn-danger btn_remove_edit_3 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_4').click(function(){
                i++;
                $('#dynamic_field_edit_4').append('<tr id="row_e_4'+i+'" class="dynamic-added"><td><input type="text" name="le4[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_4" id="'+i+'" class="btn btn-danger btn_remove_edit_4 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_5').click(function(){
                i++;
                $('#dynamic_field_edit_5').append('<tr id="row_e_5'+i+'" class="dynamic-added"><td><input type="text" name="le5[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_5" id="'+i+'" class="btn btn-danger btn_remove_edit_5 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_6').click(function(){
                i++;
                $('#dynamic_field_edit_6').append('<tr id="row_e_6'+i+'" class="dynamic-added"><td><input type="text" name="le6[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_6" id="'+i+'" class="btn btn-danger btn_remove_edit_6 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_7').click(function(){
                i++;
                $('#dynamic_field_edit_7').append('<tr id="row_e_7'+i+'" class="dynamic-added"><td><input type="text" name="le7[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_7" id="'+i+'" class="btn btn-danger btn_remove_edit_7 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_8').click(function(){
                i++;
                $('#dynamic_field_edit_8').append('<tr id="row_e_8'+i+'" class="dynamic-added"><td><input type="text" name="le8[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_8" id="'+i+'" class="btn btn-danger btn_remove_edit_8 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_9').click(function(){
                i++;
                $('#dynamic_field_edit_9').append('<tr id="row_e_9'+i+'" class="dynamic-added"><td><input type="text" name="le9[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_9" id="'+i+'" class="btn btn-danger btn_remove_edit_9 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_10').click(function(){
                i++;
                $('#dynamic_field_edit_10').append('<tr id="row_e_10'+i+'" class="dynamic-added"><td><input type="text" name="le10[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_10" id="'+i+'" class="btn btn-danger btn_remove_edit_10 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_11').click(function(){
                i++;
                $('#dynamic_field_edit_11').append('<tr id="row_e_11'+i+'" class="dynamic-added"><td><input type="text" name="le11[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_11" id="'+i+'" class="btn btn-danger btn_remove_edit_11 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_12').click(function(){
                i++;
                $('#dynamic_field_edit_12').append('<tr id="row_e_12'+i+'" class="dynamic-added"><td><input type="text" name="le12[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_12" id="'+i+'" class="btn btn-danger btn_remove_edit_12 center-block">X</button></td></tr>');
            });
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#add_edit_13').click(function(){
                i++;
                $('#dynamic_field_edit_13').append('<tr id="row_e_13'+i+'" class="dynamic-added"><td><input type="text" name="le13[]" placeholder="Escriba una fortaleza" class="form-control name_list" /></td><td><button type="button" name="remove_edit_13" id="'+i+'" class="btn btn-danger btn_remove_edit_13 center-block">X</button></td></tr>');
            });
