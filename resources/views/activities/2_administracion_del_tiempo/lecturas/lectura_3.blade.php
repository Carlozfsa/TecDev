    ...
    <div class="center-block" style="margin-left:23%">
        <nav aria-label="Page navigation">
            <ul class="pagination center-block">
                <li>
                    <a href="{{url('/tiempo_l_2')}}" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <li><a href="{{url('/tiempo_l_1')}}">Lectura 1</a></li>
                <li><a href="{{url('/tiempo_l_2')}}">Lectura 2</a></li>
                <li><a href="{{url('/tiempo_l_3')}}" style="background-color: lightgray;">Lectura 3</a></li>
                <li><a href="{{url('/tiempo_l_4')}}">Lectura 4</a></li>
                <li>
                    <a href="{{url('/tiempo_l_4')}}" aria-label="Next">
