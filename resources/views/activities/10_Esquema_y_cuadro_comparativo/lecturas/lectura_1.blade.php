  ...
  <div class="center-block" style="margin-left:25%">
    <nav aria-label="Page navigation">
        <ul class="pagination center-block">
            <li>
                <a href="{{url('/mapas_1')}}" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
            <li><a href="{{url('/mapas_1')}}"><strong>Actividad previa</strong></a></li>
            <li><a href="{{url('/esq_l_1')}}" style="background-color: lightgray;">Lectura 1</a></li>
            <li><a href="{{url('/esq_l_2')}}">Lectura 2</a></li>

            <li>
                <a href="{{url('/esq_l_2')}}" aria-label="Next">
