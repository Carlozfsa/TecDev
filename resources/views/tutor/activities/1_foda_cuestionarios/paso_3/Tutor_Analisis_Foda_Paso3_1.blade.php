        ...
        <div class="panel-body">
            ...
            <div class="instrucciones" style="margin: 10px">
                ...
                @if($edit==0)
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/store/tutor_foda_3_1')}}">
                        {{csrf_field()}}
                ...
                @else
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/edit/tutor_foda_3_1')}}">
                        {{csrf_field()}}
                        <div class="table-responsive">
  ...
  <div class="center-block" style="margin-left:20%">
    <nav aria-label="Page navigation">
        <ul class="pagination center-block">
            ...
            <li><a href="{{url('/foda_1_1')}}" style="background-color: lightgray;">Amenazas 1</a></li>
