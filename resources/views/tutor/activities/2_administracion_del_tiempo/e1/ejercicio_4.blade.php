...
@section('content')
    ...
    <div class="panel panel-default table-responsive">
        <div class="panel-heading">Ejercicio Miercoles
        </div>
        <div class="panel-body">
            ...
            <div class="instrucciones" style="margin: 10px">
                ...
                @if($edit==0)
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/store/tutor_tiempo_ej_4')}}">
                        {{csrf_field()}}
                ...
                @else
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/edit/tutor_tiempo_ej_4')}}">
                        {{csrf_field()}}
                        <div class="table-responsive">
