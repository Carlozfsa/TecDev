...
@section('content')
    ...
    <div class="panel panel-default table-responsive">
        <div class="panel-heading">Ejercicio Domingo
        </div>
        <div class="panel-body">
            ...
            <div class="instrucciones" style="margin: 10px">
                ...
                @if($edit==0)
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/store/tutor_tiempo_ej_8')}}">
                        {{csrf_field()}}

                        <div class="table-responsive">

                            @if($f1_decode!=NULL && $f2_decode!=NULL && $f3_decode!=NULL && $f4_decode!=NULL && $f5_decode!=NULL && $f6_decode!=NULL && $f7_decode!=NULL && $f8_decode!=NULL && $f9_decode!=NULL && $f10_decode!=NULL && $f11_decode!=NULL && $f12_decode!=NULL && $f13_decode!=NULL)
                            ...
                            <table class="col-lg-12">
                                ...
                                <tr>
                                    <td>
                                        <br>
                                        <textarea rows="5" name ="retro7" class="form-control"></textarea>
                                        <br>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br><br>
                                        <input type="text" name="cal7" class="form-control name_list center-block">
                                    </td>
                                </tr>
                ...
                @else
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/edit/tutor_tiempo_ej_8')}}">
                        {{csrf_field()}}
                        <div class="table-responsive">
