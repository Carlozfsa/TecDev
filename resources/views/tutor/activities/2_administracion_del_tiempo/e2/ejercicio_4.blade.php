...
@section('content')
    ...
    <div class="panel panel-default table-responsive">
        <div class="panel-heading">Segunda parte: Ejercicio Miercoles
        </div>
        <div class="panel-body">
            ...
            <div class="instrucciones" style="margin: 10px">
                ...
                @if($edit==0)
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/store/tutor_tiempo_ej_2_4')}}">
                        {{csrf_field()}}
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="col-lg-12">
                                ...
                                <tr>
                                    <td>
                                        <br>
                                        <textarea rows="5" name ="retro10" class="form-control"></textarea>
                                        <br>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br><br>
                                        <input type="text" name="cal10" class="form-control name_list center-block">
                                    </td>
                                </tr>
                ...
                @else
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/edit/tutor_tiempo_ej_2_4')}}">
                        {{csrf_field()}}
                        <div class="table-responsive">
