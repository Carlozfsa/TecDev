...
@section('content')
    ...
    <div class="panel panel-default table-responsive">
        <div class="panel-heading">Segunda parte: Ejercicio Sabado
        </div>
        <div class="panel-body">
            ...
            <div class="instrucciones" style="margin: 10px">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="col-lg-12">
                                ...
                                <tr>
                                    <td>
                                        <br>
                                        <textarea rows="5" name ="retro13" class="form-control"></textarea>
                                        <br>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br><br>
                                        <input type="text" name="cal13" class="form-control name_list center-block">
                                    </td>
                                </tr>
                ...
                @else
                    ...
                    <form name="add_fort" id="add_fort" method="post" action="{{url('/edit/tutor_tiempo_ej_2_7')}}">
                        {{csrf_field()}}
                        <div class="table-responsive">
